...
# def handle_mega_reaction(slack_app: App, event: dict, say) -> None:
#     """
...
#     channel_id = slack_app.client.conversations_open(users=user_id)["channel"]["id"]
#     slack_app.client.chat_postMessage(channel=channel_id, text="Hello, how can I help you today? Please reply in the thread to initiate a conversation.")

#     # Temp fix: Reply in thread with reaction
#     # say("Hello, how can I help you today?", thread_ts=event.get("item", {}).get("ts"))
